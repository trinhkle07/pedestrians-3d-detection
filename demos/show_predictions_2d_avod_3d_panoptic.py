...
import pplp
from pplp.builders.dataset_panoptic_3d_builder import DatasetBuilder
    ...
    for sample_idx in range(dataset.num_samples):
        ...
        if draw_predictions_separate or draw_overlaid:
            ...
            if len(prediction_boxes_3d) > 0:
                ...
                print('avod_score_threshold = ', avod_score_threshold)
        ...
        filtered_gt_objs = dataset.panoptic_3d_utils.filter_labels(
        ...
        if draw_proposals_separate or draw_overlaid:
            ...
            panoptic_utils = dataset.panoptic_3d_utils
            ...
            print('np.max(bev_img) = ', np.max(bev_img))
