...
import pplp
from pplp.protos import model_pb2
from pplp.protos import panoptic_pipeline_pb2
...
def get_configs_from_pipeline_file(pipeline_config_path,
                                   is_training):
    """Reads model configuration from a panoptic_pipeline_pb2.NetworkPipelinePanopticConfig.
    Args:
    ...
    Returns:
        ...
        dataset_config: A panoptic_dataset_pb2.PanopticDatasetConfig
    """

    pipeline_config = panoptic_pipeline_pb2.NetworkPipelinePanopticConfig()
