...
from pplp.protos import kitti_dataset_pb2
from pplp.protos.kitti_dataset_pb2 import KittiDatasetConfig
...
class DatasetBuilder(object):
    ...
    KITTI_UNITTEST = KittiDatasetConfig(
        name="unittest-kitti",
        dataset_dir=pplp.root_dir() + "/tests/datasets/Kitti/object",
        data_split="train",
