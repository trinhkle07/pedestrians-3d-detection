...
def tf_project_to_image_space(anchors, stereo_calib_p2, image_shape):
    ...
    pts_2d = tf.Print(pts_2d, ['pts_2d.reshape0 =', tf.reshape(pts_2d[0, :], (-1, 8))], summarize=100)
    pts_2d = tf.Print(pts_2d, ['pts_2d.reshape1 =', tf.reshape(pts_2d[1, :], (-1, 8))], summarize=100)
...
def project_to_image_tensor(points_3d, cam_p2_matrix):
    ...
    """
    cam_p2_matrix = tf.Print(cam_p2_matrix, ['cam_p2_matrix =', cam_p2_matrix], summarize=100)
