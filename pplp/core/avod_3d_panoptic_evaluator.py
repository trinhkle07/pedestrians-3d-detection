    ...
    def run_latest_checkpoints(self):
        ...
        if ckpt_indices is not None:
            ...
            for ckpt_idx in ckpt_indices:
                ...
                # checkpoint_to_restore = '/home/trinhle/PPLP/src/PPLP/avod/data/outputs/avod_3d_pedestrian_panoptic/checkpoints/avod_3d_pedestrian_panoptic-00240000'
                checkpoint_to_restore = '/home/trinhle/LidarPoseBEV/src/PPLP/avod/data/outputs/avod_3d_pedestrian_panoptic/checkpoints/avod_3d_pedestrian_panoptic-00270000'
