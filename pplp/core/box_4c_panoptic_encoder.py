...
def np_box_3d_to_box_4c(box_3d, ground_plane):
    ...
    anchor = box_3d_panoptic_encoder.box_3d_to_anchor(box_3d, ortho_rotate=True)[0]
...
def tf_box_3d_to_box_4c(boxes_3d, ground_plane):
    ...
    anchors = box_3d_panoptic_encoder.tf_box_3d_to_anchor(boxes_3d)
...
def tf_box_4c_to_box_3d(boxes_4c, ground_plane):
    ...
    # Use reshape instead of squeeze, in case tf.shape()=[1]
