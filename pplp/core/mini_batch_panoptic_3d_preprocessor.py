...
class MiniBatchPreprocessor(object):
    ...
    def preprocess(self, indices):
        ...
        for sample_idx in indices:
            ...
            # Here, we created 448 boolean masks for all 488 anchors,
            ...
            # print('self._density_threshold = ', self._density_threshold)
            ...
            anchor_ious = anchors_info[:, self.mini_batch_panoptic_3d_utils.col_ious]
            ...
            if len(anchor_ious) == 0 or np.max(anchor_ious) == 0:
    ...
    def preprocess_mrcnn(self, indices):
        ...
        # Make folder if it doesn't exist yet
        sub_str = 'orient'  # First, make the 'orient' folder for OrientNet
        output_dir = self.mini_batch_panoptic_3d_utils.make_file_path(
            classes_name,
            sub_str,
            sample_name=None)
        os.makedirs(output_dir, exist_ok=True)
        sub_str = 'mrcnn'  # Then, make the 'mrcnn' folder for mrcnn results
        output_dir = self.mini_batch_panoptic_3d_utils.make_file_path(
            classes_name,
            sub_str,
            sample_name=None)
    ...
    def _check_for_existing(self, classes_name, anchor_strides, sample_name):
        ...
        file_name = self.mini_batch_panoptic_3d_utils.get_file_path(
            classes_name,
            anchor_strides,
            sample_name)
    ...
    def _check_for_mrcnn_existing(self, classes_name, sub_str, sample_name, subsub_str=None):
        ...
        file_name = self.mini_batch_panoptic_3d_utils.make_file_path(classes_name,
                                                                  sub_str,
                                                                  sample_name,
    ...
    def _save_to_file(self, classes_name, anchor_strides, sample_name,
        ...
        file_name = self.mini_batch_panoptic_3d_utils.get_file_path(classes_name,
                                                                    anchor_strides,
                                                                    sample_name)
...
# result['rois'] = array
    ...
    def _visualize_mrcnn_to_file(self, image, classes_name, sub_str, sample_name,
        ...
        file_name = self.mini_batch_panoptic_3d_utils.make_image_path(classes_name,
                                                                   sub_str,
                                                                   sample_name)
