...
from pplp.builders import bev_generator_builder
from pplp.core.label_cluster_utils import LabelClusterUtils
from pplp.core.mini_batch_utils import MiniBatchUtils
...
class KittiUtils(object):
    ...
    def get_mrcnn_result(self, img_idx):
        ...
        mrcnn_result = self.mini_batch_utils.load_mrcnn_mini_batches(img_idx)
        return mrcnn_result
