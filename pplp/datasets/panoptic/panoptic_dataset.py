...
class PanopticDataset:
    ...
    def load_samples(self, indices, OrientNet=False):
        ...
        for sample_idx in indices:
            ...
            # file_name = '/home/trinhle/play/try_python/500100018739_bev_height.npy'
            # print('_save_mrcnn_to_file :: file_name = ', file_name)
            # np.save(file_name, height_maps)
            # file_name = '/home/trinhle/play/try_python/500100018739_bev_density.npy'
            # print('_save_mrcnn_to_file :: file_name = ', file_name)
            # np.save(file_name, density_map)

            bev_input = np.dstack((*height_maps, density_map, *occupancy_maps))

            # file_name = '/home/trinhle/play/try_python/500100018739_bev_stack.npy'
            # print('_save_mrcnn_to_file :: file_name = ', file_name)
