...
import pplp
import pplp.builders.config_builder_util as config_builder
...
from pplp.core.pplp_kitti_evaluator import Evaluator
...
def evaluate(model_config, eval_config, dataset_config):
    ...
    with tf.Graph().as_default():
        if model_name == 'pplp_model':
            model = PplpModel(model_config, train_val_test=eval_mode,
                              dataset=dataset)
