...
def do_preprocessing(dataset, indices):
    ...
    mini_batch_panoptic_3d_utils = dataset.panoptic_3d_utils.mini_batch_panoptic_3d_utils

    print("Generating mini batches in {}".format(
        mini_batch_panoptic_3d_utils.mini_batch_dir))

    # Generate all mini-batches, this can take a long time
    mini_batch_panoptic_3d_utils.preprocess_mrcnn_mini_batches(indices)
    mini_batch_panoptic_3d_utils.preprocess_rpn_mini_batches(indices)
